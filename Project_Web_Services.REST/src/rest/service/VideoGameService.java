...
public class VideoGameService {
	...
	public VideoGame addVideoGame(VideoGame videoGame) throws SQLException
	{
		...
		{
			throw new SQLIntegrityConstraintViolationException("Le champ 'title' ne peut �tre vide (null)");
		}
			...
			if (succes == 1) {
				...
				if (generated_id.next())
				{
					...
					if(succes2 == 1){
						...
						ppsm3.setLong(1, generated_id.getLong(1));
						...
						if(rs.next()){
							...
							//create the new video game Object with rs and return it
							return videoGame;
