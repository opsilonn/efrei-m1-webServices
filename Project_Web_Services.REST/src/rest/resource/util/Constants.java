...
public class Constants {
	...
	public class Rate{
		...
		public static final String DeleteByMult ="DELETE FROM Rate WHERE id_multimedia = ?";
	...
	public class Comment{
		...
		public static final String deleteByMult = "DELETE FROM Comment WHERE id_multimedia = ?";
	...
	public class Multimedia{
		...
		public static final String delete = "DELETE FROM multimedia WHERE ID_multimedia = ?";
	...
	public class Film{
		...
		public static final String delete ="DELETE FROM film where ID_film = ?";
	}
