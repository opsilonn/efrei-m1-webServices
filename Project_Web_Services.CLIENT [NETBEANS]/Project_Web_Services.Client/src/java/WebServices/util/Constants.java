...
public class Constants
{
    ...
    public static final String PATH_PAGE_HOME = "WEB-INF/home.jsp";
    public static final String PATH_PAGE_LOGIN = "WEB-INF/login.jsp";
    public static final String PATH_PAGE_LOGOUT = "WEB-INF/logout.jsp";
